# ORecipe - Projet pendant la formation

Projet d'apprentissage pour faire des wireframes puis manipuler css, gsap, keyframes. Créez un menu responsive avec animation. 
Vous pouvez cliquer sur le lien ci-dessous pour voir le site.
